...
<html>
    ...
    <body>
        ...
        <div class="conteudo">
            <hr>
            <center><text id="idPessoaCont"><%=pessoa.getNomePessoa()%></text></center>
            <hr>
            <form id="formPessoa" action="" method="POST">
                ...
                <table border="0">
                    <tbody>
                        <tr>
                            ...
                            <td><input id="idCodigo" type="text" name="codigo" value="<%=pessoa.getIdPessoa()%>" disabled="enabled"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input id="idDataNasc" type="text" name="nascdate" value="<%=format.format(pessoa.getDataNasc())%>" disabled="enabled"/></td>
                        </tr>
                        <tr>
				...
				<select id="idCidade" name="cidade" disabled="enabled">
					...
					%>
                                    <option value="<%= cidade.getIdCidade()%>" <%= cidade.getIdCidade()==pessoa.getCidade().getIdCidade()?"selected":"" %> > <%= cidade.getNomeCidade()%> </option>
                                    <%}%>
				</select>			
                            </td>
                        </tr>
